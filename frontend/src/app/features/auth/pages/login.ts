  ...
  template: `<div class="min-h-screen flex flex-col items-center justify-center bg-[#09090b] px-4">
    ...
    <div class="w-full max-w-md bg-[#18181b] border border-zinc-800 rounded-xl p-8 shadow-2xl">
      ...
      <div class="relative my-4 flex items-center justify-center">
        ...
        <span class="relative bg-[#18181b] px-3 text-xs text-zinc-500 uppercase tracking-wider">or</span>
      </div>

      <button
        type="button"
        
        class="w-full flex items-center justify-center bg-[#09090b] text-zinc-200 font-medium py-3 rounded-lg border border-zinc-700 hover:bg-zinc-800 hover:border-zinc-600 active:scale-[0.98] transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
        [disabled]="loading()"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48" class="mr-2.5">
