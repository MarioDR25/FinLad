...
@Component({
  ...
  standalone: true,
  template: `
    <div class="py-8 px-4 md:px-8 rounded-xl border border-[#3c4a42] bg-[#161d19]">
          ...
          <thead>
            ...
            <tbody class="divide-y divide-[#3c4a42]/30">
              ...
              <tr class="hover:bg-[#2f3632]/20 transition-colors">
                <td class="py-4"><div class="flex items-center gap-3"><span class="text-base text-[#dde4dd]">{{ tx.description }}</span></div></td>
