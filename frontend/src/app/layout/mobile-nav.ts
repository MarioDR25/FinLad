...
@Component({
  ...
  template: `
    <nav class="fixed bottom-0 left-0 w-full z-50 flex md:hidden justify-around items-center px-4 pb-4 pt-2 bg-[#216d69]   rounded-t-full">
      ...
      <a routerLink="/dashboard" routerLinkActive="bg-white/20 rounded-xl px-3 py-1" [routerLinkActiveOptions]="{exact: true}" class="flex flex-col items-center -mt-8">
      ...
      <a routerLink="/analytics" routerLinkActive="bg-white/20 rounded-xl px-3 py-1" [routerLinkActiveOptions]="{exact: true}" class="flex flex-col items-center text-white/70">
        <i class="fa-solid fa-chart-pie text-lg"></i><span class="text-xs">Analytics</span>
      </a>
      <a routerLink="/transactions" routerLinkActive="bg-white/20 rounded-xl px-3 py-1" [routerLinkActiveOptions]="{exact: true}" class="flex flex-col items-center text-white/70">
        <i class="fa-solid fa-clock-rotate-left text-lg"></i><span class="text-xs">Transactions</span>
      </a>
      <a routerLink="/wallets" routerLinkActive="bg-white/20 rounded-xl px-3 py-1" [routerLinkActiveOptions]="{exact: true}" class="flex flex-col items-center text-white/70">
